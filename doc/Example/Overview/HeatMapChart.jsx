...
const HeatMapChart = props => {
  ...
  useEffect(() => {
    chartIns.init(heatMapChartRef.current);
    chartIns.setSimpleOption('HeatMapChart', chartOpt, {});
    return () => {
      chartIns.uninstall();
    };
  }, []);
  ...
  return <div style={{ width: '100%', height: '100%' }} ref={heatMapChartRef}></div>;
};
