		...
		const airportCardData = {
			...
			operation:{
				data:[{
						...
						type: 'icon',
						data: [{
								path: 'data:image/image/png;base64,',
								name: 'refresh'
						}],
				}],
				onChange: (data, index) => {
		...
		const productCardData = {
			...
			operation:{
				data:[{
						type: 'icon-button',
						data: [{
								path: 'data:image/image/png;base64,',
								name: 'line'
						},{
								path: 'data:image/image/png;base64,',
								name: 'bar'
						}],
						active: 0
				},{
