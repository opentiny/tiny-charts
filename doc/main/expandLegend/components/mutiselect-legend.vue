<template>
    <div style="width: 50%; margin-left: 25%; padding: 20px 20px 0 20px; border-radius: 10px; box-shadow: 0px 0px 15px rgba(0, 0, 0, 0.1); position: relative">
        <div class="chart-container" ref="chartContainer" style="width: 100%; height: 500px" :style="{ height: '500px' }"></div>
    </div>
</template>
<script>
