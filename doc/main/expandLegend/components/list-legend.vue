<template>
	<div
		style="width: 70%;margin-left: 15%;padding: 20px;border-radius: 10px;box-shadow:  0px 0px 15px rgba(0, 0, 0, 0.1);">
		<div class="chart-container" ref="airportChartContainer" style="width: 100%;height: 500px"
			:style="{ height: '500px' }">
		</div>
	</div>
</template>
