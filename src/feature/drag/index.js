...
class DragManager {
    ...
    createTools({ enlarge, center, shrunk }) {
        let stateDom = `<div class="drag-tools">
            <div class="drag-tool-item drag-tool-enlarge" style='background:url(${enlarge})'></div>
            <div class="drag-tool-item drag-tool-center" style='background:url(${center})'></div>
            <div class="drag-tool-item drag-tool-shrunk" style='background:url(${shrunk})'></div>
        </div>`;
