...
function getModelToken(aliasToken) {
  ...
  return {
    ...
    /** ----- dataZoom------ */
    // 手柄中心填充色
    dataZoomHandleColor: colorBgHandle,
    // 手柄外框色
    dataZoomHandleBorderColor: colorBorderHandle,
    // 手柄阴影色
    dataZoomHandleShadowColor: colorShadowHandle,
    // 手柄hover时中心填充色(todo待处理)
    dataZoomEmphasisHandleColor: colorBgHandle,
    // 手柄hover时外框色
    dataZoomEmphasisHandleBorderColor: colorBorderHandle,
  };
}
